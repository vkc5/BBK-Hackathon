                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (_isBiometricSupported) {
                                        try {
                                          _model.manualBiometricResult =
                                              await _localAuth.authenticate(
                                                  localizedReason:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                            '6vmddv6f' /* Please authenticate to log in */,
                                          ));
                                        } on PlatformException {
                                          _model.manualBiometricResult = false;
                                        }
                                        safeSetState(() {});
                                      }

                                      if (_model.manualBiometricResult!) {
                                        context
                                            .pushNamed(MYCardWidget.routeName);
                                      } else {
